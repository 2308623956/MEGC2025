...
# ====== 配置路径 ======
MODEL_PATH = "/workspace/LLaMA-Factory-main/save_models/qwen2.5_vl_7b_sft_model_250626/checkpoint-40"
INPUT_JSONL = "/workspace/data/7b_test/me_vqa_samm_test_to_answer.jsonl"
OUTPUT_JSONL = "/workspace/data/7b_test/me_vqa_samm_test_pred.jsonl"
VIDEO_ROOT = "/workspace/data/ME_VQA_MEGC_2025_Test/SAMM/"  # 确保最后有斜杠
